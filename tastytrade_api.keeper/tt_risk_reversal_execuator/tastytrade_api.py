...
class TastytradeAPI:
    def __init__(self, base_url: str):
        ...
        self.session.headers.update({"User-Agent": "python-script/1.0"})  # ADD THIS LINE        
    ...
    def login(self, username: str, password: str) -> str:
        ...
        r = self.session.post(url, json=payload, timeout=15)  # Headers now include User-Agent
    ...
    def get_order(self, account_number: str, order_id: str) -> Dict:
        ...
        return self.get(f"/accounts/{account_number}/orders/{order_id}")
